...
/*
  transport-toggle
*/
document.getElementById('place-toggle').addEventListener('click', function() {
  var component = document.getElementById('place-component');

  // Toggle display property
  if (window.getComputedStyle(component).display === 'none') {
...
document.getElementById('place-toggle2').addEventListener('click', function() {
  var component = document.getElementById('place-component');
